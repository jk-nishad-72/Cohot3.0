...
const Register = () => {
  ...
  const handleSubmitForm = (data) => {
     ...
     let arr =  users.find((user)=> user.email ===  data.email );
     ...
     arr = [...users , {...data , id:Date.now().toString()}]
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10 lg:p-16">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-[#64798A] text-[14px] mb-9">
            A few details and your logbook is ready.
          </motion.p>

          {/* username */}
          <motion.div variants={itemVariants} className="mb-7">
            <label htmlFor="username" className="block text-xs font-medium text-[#64798A] tracking-wide mb-2">
              User Name
            </label>
            <div className="relative flex items-center">
              <FiUser
                ...
                className={`absolute left-0 transition-colors duration-200 ${
                  focusField === 'username' ? 'text-[#2FBFA8]' : 'text-[#A9B8BE]'
                }`}
              />
              <input
                id="username"
                ...
                {...register('username',{
                    ...
                    maxLength:{
                        value:12 , 
                        message:"Username must be at least 12 characters long"
                    },
                   
                })}
                onFocus={() => setFocusField('username')}
                onBlur={() => setFocusField(null)}
                placeholder="wayfinder92"
              ...
              <motion.span
                ...
                initial={{ width: '0%' }}
                animate={{ width: focusField === 'username' ? '100%' : '0%' }}
                transition={{ duration: 0.35, ease: [0.22, 1, 0.36, 1] }}
              />
            </div>
            {errors.username && <p className='text-red-300 text-xs'>{errors.username.message} </p>}
          </motion.div>
            ...
            <div className="relative flex items-center">
              ...
              <input
               ...
               {...register('password',{
                    ...
                    maxLength:{
                        value:15 , 
                        message:"Password must not be more then 15 characters long"
                    },
          ...
          <motion.div variants={itemVariants} className="mb-9">
            <label className="flex items-start gap-2.5 cursor-pointer select-none">
              ...
              />
              <span className="mt-0.5 shrink-0 w-4 h-4 rounded-[4px] border border-[#C7D2D6] peer-checked:bg-[#2FBFA8] peer-checked:border-[#2FBFA8] transition-colors flex items-center justify-center">
                {agree && (
              ...
              <span className="text-[13px] text-[#64798A] leading-snug">
                I agree to the{' '}
                <a href="#" className="text-[#2FBFA8] hover:underline">Terms</a> and{' '}
                <a href="#" className="text-[#2FBFA8] hover:underline">Privacy Policy</a>
              </span>
            </label>
          </motion.div>
