...
const Navabar = () => { 
  ...
  let {setView} = useContext(MyShopStore)   
  ...
  return (
    ...
    <div className="container mx-auto px-6 py-4 flex items-center justify-between">
      ...
      <div className="flex items-center space-x-6"> 
        ...
        href="#" className="text-gray-300 hover:text-green-600 transition">Cart</a> 
      </div>
       ...
       <div className="relative">
          ...
          className="text-gray-300 hover:text-green-600 transition">
            ...
            <span className="absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full px-2 py-0.5">3</span>
          </button>
        </div>
    </div>
  </nav>
